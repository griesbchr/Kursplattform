...
function deregCallback() {
  ...
  //--------------------------check if less than max number---------------------------------
  
  //if (rows.length > MAX_DEREG_STUDENTS) {
  //  SpreadsheetApp.getActiveSpreadsheet().toast("Es können maximal "+ MAX_DEREG_STUDENTS +" SchülerInnen auf einmal zurückgegeben werden.") 
  //  return
  //  }
